#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NSRE-weighted images + NMF component vector bypass."""
...
def main() -> None:
    ...
    rows = [
        {"model": "NSREWeight_Images_NMF_Bypass", "metric": "accuracy", "value": round(float(np.mean(accs)), 4)},
        {"model": "NSREWeight_Images_NMF_Bypass", "metric": "macro_f1", "value": round(float(np.mean(f1s)), 4)},
    ]
