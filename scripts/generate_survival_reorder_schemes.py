...
def main():
    ...
    nsre_map = order_tsv.set_index("feature")["nsre"].to_dict()
    ...
    save_scheme("scheme1_function_block", order1, row_major_positions(SIZE), X, cat, nsre_by_idx, feature_names, nsre_map)
    ...
    save_scheme("scheme2_function_center", order2, spiral_order(SIZE), X, cat, nsre_by_idx, feature_names, nsre_map)
    ...
    save_scheme("scheme3_expression_cluster", order3, row_major_positions(SIZE), X, cat, nsre_by_idx, feature_names, nsre_map)
